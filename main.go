...
import (
	"fmt"
	"invoice-pdf-generator/internal"
)

func main() {
	// Generate sample invoice data
	productInvoiceData, err := internal.NewInvoiceData("Product application", 1, 3000.50)
	if err != nil {
		panic(err)
	}
	...
	invoiceItems := []*internal.InvoiceData{productInvoiceData, laptopInvoiceData}
